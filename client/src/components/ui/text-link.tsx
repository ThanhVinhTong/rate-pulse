...
export const textLinkVariants = cva("transition", {
  variants: {
    variant: {
      ...
      nav: "inline-flex min-h-10 items-center rounded-md px-3 text-sm font-medium text-slate-300 hover:bg-white/10 hover:text-white",
      navCta: "inline-flex min-h-10 items-center rounded-md bg-primary px-4 text-sm font-semibold text-white shadow-sm transition hover:bg-primary-muted",
      navOutline:
        "inline-flex min-h-10 flex-1 items-center justify-center rounded-md border border-white/15 px-4 text-sm font-medium text-slate-200 hover:bg-white/10 hover:text-white",
      subtle: "text-center text-sm font-medium text-text-muted underline-offset-4 hover:text-text-primary sm:text-left",
      cta: "inline-flex min-h-11 min-w-[200px] items-center justify-center rounded-md bg-primary px-6 text-base font-semibold text-white shadow-sm transition hover:bg-primary-muted",
