...
class MBB(FX):
    def __init__(self, driver, connection):
        ...
        self.bank_constants = get_bank_constant('mbb')
    ...
    def get_fx(self) -> None:
        ...
        """
        self.driver.get("https://webgia.com/ty-gia/mbbank/")
        time.sleep(1)
        ...
        for row in rows:
            ...
            if currency_code == "USD (USD 50-100)":
                currency_code = "USD"
            ...
            sell_cash = cells[3].text.strip()
            sell_transfer = cells[4].text.strip()
            ...
            for type_name, rate_val in rates_to_save.items():
                if rate_val is not None:
                    fx_list.append({
                        "source_code": "MBB", # Identifies the source
