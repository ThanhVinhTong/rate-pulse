...
func (x *CreateUserRequest) GetLanguagePreference() string {
	if x != nil {
...
func (x *CreateUserRequest) GetCountryOfResidence() string {
	if x != nil {
...
func (x *CreateUserRequest) GetCountryOfBirth() string {
	if x != nil {
...
const file_rpc_create_user_proto_rawDesc = "" +
	...
	"\x13language_preference\x18\x05 \x01(\tR\x12languagePreference\x120\n" +
	"\x14country_of_residence\x18\x06 \x01(\tR\x12countryOfResidence\x12(\n" +
	"\x10country_of_birth\x18\a \x01(\tR\x0ecountryOfBirth\x12\x1d\n" +
	"\n" +
	"first_name\x18\b \x01(\tR\tfirstName\x12\x1b\n" +
	"\tlast_name\x18\t \x01(\tR\blastName\"2\n" +
	"\x12CreateUserResponse\x12\x1c\n" +
	"\x04user\x18\x01 \x01(\v2\b.pb.UserR\x04userB(Z&github.com/ThanhVinhTong/rate-pulse/pbb\x06proto3"
